...
/**
 * @fn   int net_wifi_set_autoconnect(const char *profile_name, gboolean autoconnect)
 *
 * This function enables or disables Wi-Fi auto-connection.
 *
 * \par Sync (or) Async:
 * This is an Synchronous API.
 *
 * @param[in]    profile_name  Profile Name to be set
 * @param[in]    autoconnect   enable/disable
 * @param[out]   none
 *
 *
 * @return       NET_ERR_NONE on success, negative values for errors
...
int net_wifi_set_autoconnect(const char *profile_name, gboolean autoconnect);

/**
 * @fn   int net_wifi_set_local_only_network(const char *profile_name, gboolean value)
 *
 * This function sets or unsets Wi-Fi LocalNetwork property.
 *
 * \par Sync (or) Async:
 * This is an Synchronous API.
 *
...
int net_wifi_set_local_only_network(const char *profile_name, gboolean value);
